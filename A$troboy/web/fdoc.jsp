		 ...
		 <div class="container">
			 ...
			 <nav>
				 <ul>
                                     ...
                                     <li class="current"><a href="fdoc.jsp">DOCUMENTS</a></li>
                     ...
                     <div style="float: right;font-style: italic; font-family: cursive;">
                         ...
                         <br>
                         <div class="container"><form class="animated slideInDown" action="FileUploadServlet" method="post" enctype="multipart/form-data">
                                 <input type="hidden" name="know" value="1"/>
                                 <div style="float: left;">    <table border="0" cellspacing="4" cellpadding="1" >
                    <thead>
                        <tr>
                            <th><br></th>
                            <th><br></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><label style="padding-right: 50px">Image Link: </label></td>
                        ...
                        <div style="padding-top: 10px;">   <input  type="submit" value="Submit" /></div><br>
            </form>
